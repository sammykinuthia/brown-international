        ...
        <section>
            ...
            <article className="container px-4 mx-auto my-8">
                ...
                <p className="text-gray-600 py-2">
                    Sure, here is an about page for MasterBrown International Institute. MasterBrown International Institute is a leading provider of education in Kenya. We offer a wide range of programs, from early childhood education to university-level courses. Our mission is to provide our students with the knowledge and skills they need to succeed in today's global economy.<br /><br />
