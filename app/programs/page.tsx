...
export default function Page() {
    ...
    return (
        <div className="">
        <Banner title="We offer the best programs in the market today, which gives you an edge in the tech world"/>
            <section className="bg-green-50 my-8 p-2 mx-4 md:mx-8 lg:mx-20 xl:mx-28 2xl:mx-36">
